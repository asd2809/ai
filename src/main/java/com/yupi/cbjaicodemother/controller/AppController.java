...
import com.yupi.cbjaicodemother.common.DeleteRequest;
...
import com.yupi.cbjaicodemother.model.dto.app.*;
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
        ...
        return contentFlux
                .map(chunk ->{
                    ...
                    /// 发送一条sse的消息，
                    return ServerSentEvent.<String>builder() /// sse的泛型构造器，声明这个SSE的数据类型为String
                            .data(jsonData)   /// 消息内容
                            .build();
                })
                /// 用于前端判断是否为正常结束
